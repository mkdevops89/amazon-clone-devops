...
1. Clone the specific learning branch:
   git clone -b phase-2-docker --single-branch https://github.com/mkdevops89/amazon-clone-devops.git amazon-phase-2
...
1. Launch Instance (AWS Console):
   ...
   - Storage: 20GB
   - Advanced Details -> IAM Instance Profile: Create new instance profile to connect to ec2 if you dont want to use ssh.
...
3. Install Tools (Automated):
   ...
   git clone -b phase-2-docker --single-branch https://github.com/mkdevops89/amazon-clone-devops.git
